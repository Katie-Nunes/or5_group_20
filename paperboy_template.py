...
def simulated_annealing(instance, initial_solution, temp=100, cooling=0.95, iterations=10, method="best"):
    ...
    while temp > 1:
        for _ in range(iterations):
            # Create neighbor by perturbing current solution
...
def main():
    """Execute full experimental workflow"""
    # Configuration
    global NUM_PAPERBOYS
    NUM_PAPERBOYS = 4

    # Read and prepare instance
    ...
    solution, time_taken = simulated_annealing(instance, random_solution, 100, 0.99, 10, method="random")
